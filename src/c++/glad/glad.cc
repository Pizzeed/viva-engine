/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun May 11 20:59:13 2025.
...
#      endif
#    elif _MSC_VER >= 1'700 && ! _USING_V110_SDK71_
#      define HAVE_WINAPIFAMILY 1
#    endif
#  endif
...
typedef void*(APIENTRYP PFNGLXGETPROCADDRESSPROC_PRIVATE)(char const*);
...
#  else
  static char const* NAMES[] = {"libGL.so.1", "libGL.so"};
#  endif
...
#endif
    exts = (char const*)glGetString(GL_EXTENSIONS);
#ifdef _GLAD_IS_SOME_NEW_VERSION
  }
  else {
    int index;
...
static void find_coreGL(void)
{
  ...
  char const* version;
  char const* prefixes[] = {"OpenGL ES-CM ", "OpenGL ES-CL ", "OpenGL ES ", NULL};
